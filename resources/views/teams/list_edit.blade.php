@extends($roll == "user" ? 'layout.accounts_template' : "layout.admin_template")
            ...
            <div class="row">
                ...
                <div class="col-5 justify-content-start">
                    <div class="input-group mb-3">
                        ...
                        @if ($list->photo_case)
                            <a class="m-1"
                                href="{{ route("$prefix.image.view", Hashids::encode($list->photo_case)) }}">تصویر</a>
                        @endif
                    </div>
                    @error('photo_case')
                    ...
                    <div class="input-group mb-3">
                        ...
                        @if ($list->photo_identity_card)
                            <a class="m-1"
                                href="{{ route("$prefix.image.view", Hashids::encode($list->photo_identity_card)) }}">تصویر</a>
                        @endif
                    </div>
                    @error('photo_identity_card')
                        <span class="error">{{ $message }}</span>
                    @enderror
                    <div class="input-group mb-3">
                        ...
                        @if ($list->photo_national_card)
                            <a class="m-1"
                                href="{{ route("$prefix.image.view", Hashids::encode($list->photo_national_card)) }}">تصویر</a>
                        @endif
                    </div>
                    @error('photo_national_card')
                        <span class="error">{{ $message }}</span>
                    @enderror
                    <div class="input-group mb-3">
                        ...
                        @if ($list->photo_end_of_military_service)
                            <a class="m-1"
                                href="{{ route("$prefix.image.view", Hashids::encode($list->photo_end_of_military_service)) }}">تصویر</a>
                        @endif
                    </div>
                    @error('photo_end_of_military_service')
                        <span class="error">{{ $message }}</span>
                    @enderror
                    <div class="input-group mb-3">
                        ...
                        @if ($list->photo_enrollment_certificate)
                            <a class="m-1"
                                href="{{ route("$prefix.image.view", Hashids::encode($list->photo_enrollment_certificate)) }}">تصویر</a>
                        @endif
                    </div>
                    @error('photo_enrollment_certificate')
                        <span class="error">{{ $message }}</span>
                    @enderror
                    <div class="input-group mb-3">
                        ...
                        @if ($list->photo_sports_insurance)
                            <a class="m-1"
                                href="{{ route("$prefix.image.view", Hashids::encode($list->photo_sports_insurance)) }}">تصویر</a>
                        @endif
                    </div>
                    @error('photo_sports_insurance')
                        <span class="error">{{ $message }}</span>
                    @enderror
                    <div class="input-group mb-3">
                        ...
                        @if ($list->photo_contract_page_one)
                            <a class="m-1"
                                href="{{ route("$prefix.image.view", Hashids::encode($list->photo_contract_page_one)) }}">تصویر</a>
                        @endif
                    </div>
                    @error('photo_contract_page_one')
                        <span class="error">{{ $message }}</span>
                    @enderror
                    <div class="input-group mb-3">
                        ...
                        @if ($list->photo_contract_page_two)
                            <a class="m-1"
                                href="{{ route("$prefix.image.view", Hashids::encode($list->photo_contract_page_two)) }}">تصویر</a>
                        @endif
                    </div>
                    @error('photo_contract_page_two')
                        <span class="error">{{ $message }}</span>
                    @enderror
                    <div class="input-group mb-3">
                        ...
                        @if ($list->photo_coaching_card)
                            <a class="m-1"
                                href="{{ route("$prefix.image.view", Hashids::encode($list->photo_coaching_card)) }}">تصویر</a>
                        @endif
                    </div>
                    @error('photo_coaching_card')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-1"></div>
                <div class="col-5">
                    @if ($list->report_defects != null)
                        <div class="mb-3 alert-danger rounded p-3 justify-content-center float-end">ایرادات:
                            {{ $list->report_defects }}</div>
                    @endif
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" aria-label="Default"
                            aria-describedby="inputGroup-sizing-default" name="name" placeholder="همانند: سید احمد رضا"
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" aria-label="Default"
                            aria-describedby="inputGroup-sizing-default" name="surname" placeholder="همانند: محمدی منش"
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" aria-label="Default"
                            ...
                            placeholder="همانند: 1374/01/01" style="text-align: center" value="{{ $list->birthdate }}">
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" aria-label="Default"
                            ...
                            placeholder="همانند: 0019558811" style="text-align: center"
                            value="{{ $list->national_code }}">
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" aria-label="Default"
                            ...
                            placeholder="همانند: 09121234567" style="text-align: center" value="{{ $list->cellphone }}">
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" aria-label="Default"
                            aria-describedby="inputGroup-sizing-default" name="expireContract" placeholder="همانند: 1401"
                            style="text-align: center" value="{{ substr($list->expire_contract, 0, -6) }}">
                        <div class="input-group-prepend d-flex me-1">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" aria-label="Default"
                                aria-describedby="inputGroup-sizing-default" name="tShirtNumber" placeholder="همانند: 00"
                  ...
                  <div style="justify-content: space-between ; align-items: center;width: 100%" class="d-flex">
