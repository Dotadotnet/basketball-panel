                ...
                <tbody>
                    @foreach ($payments as $p)
                        <tr>
                            <td>
                                <form method="POST"
                                    action="{{ route('admin.payment.delete', ['id' => Hashids::encode($p->id)]) }}">
                                    @csrf
                            ...
                            <td>
                                <form method="POST"
                                    action="{{ route('admin.payment.confirm', ['id' => Hashids::encode($p->id)]) }}">
                                    @csrf
                                    <button type="submit" class="btn btn-xs btn-outline-success btn-flat show_confirm"
