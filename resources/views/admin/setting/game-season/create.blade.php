...
@section('content')
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        <form dir="rtl" class="m-0" method="post"
              action="{{ route('admin.setting.game_season.store') }}">
            @csrf
            <div class="row">
                <div class="col-2"></div>
                <div class="col-4">
                    ...
                    <div class="m-2">
                        ...
                        <input class="form-control" type="text" name="date" id="date"
                               placeholder="{{ \Hekmatinasser\Verta\Verta::now()->format('Y/m/d') }}">
                    </div>
                    ...
                    <div class="m-2">
                        ...
                        <select class="form-select text-center" aria-label="Default select example" name="category_id"
                            ...
                            @foreach($category as $c)
                                <option value="{{ Hashids::encode($c->id) }}">{{ $c->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="m-2">
                        ...
                        <select class="form-select text-center" aria-label="Default select example"
                            ...
                            @foreach($allowAge as $a)
                                <option value="{{ Hashids::encode($a->id) }}">{{ $a->date }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="col-4">
                    ...
                    <div class="m-2">
                        ...
                        <input class="form-control text-center" aria-label="Default select example" name="start_time_at"
                    ...
                    <div class="m-2">
                        ...
                        <input class="form-control text-center" aria-label="Default select example"
                               name="finish_time_at"
                               id="finish_time_at" dir="ltr"
                               placeholder="{{ \Hekmatinasser\Verta\Verta::now()->format('Y/m/d H:i:s') }} همانند">
                    </div>
