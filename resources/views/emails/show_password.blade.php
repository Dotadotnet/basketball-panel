...
<body>
    <div class="container">
        ...
        @endcomponent
        <div style="width: 100%;">
            <h2 style="margin-bottom: 2px ;margin-top: 0px;">فراموشی رمز عبور</h2>
            <p style="margin-top: 15px;">رمز زیر رمز عبور شماست لطفا کپی کرده و برای ورود اقدام نمایید ، باتشکر</p>
            <div class="code-box" style="margin-top: 20px;direction: ltr;" id="verificationCode">{{ $password }}</div>
            <br>
            <div class="footer">
